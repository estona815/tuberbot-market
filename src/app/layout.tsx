...
export const metadata: Metadata = {
  ...
  openGraph: {
    type: "website", locale: "ko_KR", siteName: "튜버봇",
    title: "튜버봇 | 유튜버 탐색과 광고 협업",
    description: "광고 협업 전 과정을 직접 확인하는 검토판. 실제 청구·지급은 제공하지 않습니다.",
    images: [{ url: "/og-tuberbot.png", width: 1200, height: 630, alt: "튜버봇 — 광고 협업 워크스페이스" }],
  },
